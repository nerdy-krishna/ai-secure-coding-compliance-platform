...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        "fk_scans_specialized_llm_config_id",
        "scans",
        "llm_configurations",
...
def downgrade() -> None:
    ...
    op.drop_constraint(
        "fk_chat_sessions_project_id", "chat_sessions", type_="foreignkey"
    )
    op.drop_constraint(
        "fk_scans_specialized_llm_config_id", "scans", type_="foreignkey"
    )
