...
| 05 | [Remediation Flow](./05-remediation-flow.md)                          | Deterministic SUGGEST/REMEDIATE patch planning, atomic application, tree-sitter + Semgrep verification |
...
| **Patch planner** | Deterministic exact-range planner that rejects ambiguity/overlap, applies files atomically, and emits candidate-to-hunk lineage |
